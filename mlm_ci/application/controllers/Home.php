...
class Home extends CI_Controller {
    ...
    public  function remove_cart($rowid) {
        ...
        public function Register(){
            ...
            print_r("something went worng");die();  
            //$data['user_id']=$user_id;
            }
        }
            ...
            print_r("something went wrong 3");die();  
            //$data['user_id']=$user_id;
                }
            }
            ...
            if($this->Home_model->insertData($data)){
                ...
                print_r("something went wrong 5");die(); 
                //$data['user_id']=$user_id;
                }
            }
            else{
            ...
            $user_id=$user_id + 1;
                ...
                print_r("something went wrong 7");die(); 
                //$data['user_id']=$user_id;
                }
            }              
        }
    public function register_validate(){
        ...
        $user_id=$this->input->post('full_name');
        $user_referal_id=$this->input->post('referal_id');
        $parent_id=$this->input->post('parent_id');
        if($parent_id==0){
            $data = array(
            // 'user_id'=>$user_id,
            'parent_id'=>$user_referal_id,
            ...
            if($this->Home_model->updateData($user_id,$data)){     
            print_r("something went wrong ok");die();               
